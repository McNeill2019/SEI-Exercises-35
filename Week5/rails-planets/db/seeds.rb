...
#this ensures that the table will always be in exactly the same state after running the seed command; keeps things predictable!
...
Planet.create name: 'Venus', orbit: 0.5, mass: 0.5, diameter: 0.5, moons: 2, image: 'https://cdn.mos.cms.futurecdn.net/pNX8eVGowB6WT8tyrTMufk-1200-80.jpg'
